...
evaluation_function_meigo_nonlinear_combined(x = x_0, 
                                             ...
                                             bloomJDays = pheno_cal_list[late_cult],
                                             SeasonList = season_cal_list[late_cult],
                                             n_cult = ncult)
...
x_0 <- res_list2$xbest
x_U <- c(rep(60,ncult),   rep(500,ncult),   rep(1.5,ncult),  30,   281,      287,       48,             50,       10,   40,    10,    5.00)
x_L <- c(rep(5,ncult),    rep(100,ncult),   rep(0.1,ncult),  15,   279,      286,       16,             24,        2,   20,     0,    1.2)
...
saveRDS(res_list3, file = 'data/late_cult_res_list_3.RDS')
